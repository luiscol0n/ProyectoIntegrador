    ...
    public static void iniciarPrueba() {
        Thread estacion1 = new Thread(() -> {
            while (true) {
                ...
                new Publicador("pub-estacion1").enviarMensaje("/itt363-grupo1/estacion-1/sensores/datos", mensaje);
                try {
                    Thread.sleep(3000);
        ...
        Thread estacion2 = new Thread(() -> {
            while (true) {
                ...
                String mensaje = gson.toJson(sensor);
                new Publicador("pub-estacion2").enviarMensaje("/itt363-grupo1/estacion-2/sensores/datos", mensaje);
                try {
                    Thread.sleep(5000);
                } catch (InterruptedException e) {
                    e.printStackTrace();
